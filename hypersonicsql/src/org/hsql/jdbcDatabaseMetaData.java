...
public class jdbcDatabaseMetaData implements DatabaseMetaData {
  ...
  String tableNamePattern,String columnNamePattern) throws SQLException {
    ...
    if(columnNamePattern!=null) {
      where=addWhere(where,"COLUMN_NAME LIKE '"+
  ...
  String tableP,boolean unique,boolean approximate) throws SQLException {
...
//#endif JAVA2
  ...
  private ResultSet executeSelect(String table,String where)
  throws SQLException {
    if(where!=null) {
      table+=" WHERE "+where;
    }
